...
openssl_md_meth_names = None # (!) real value is "frozenset({'shake_128', 'sha512_224', 'sha1', 'whirlpool', 'sha512', 'blake2b', 'sha3_512', 'sha256', 'sha224', 'sha3_384', 'sm3', 'blake2s', 'sha384', 'md5', 'sha512_256', 'sha3_256', 'md5-sha1', 'md4', 'mdc2', 'ripemd160', 'sha3_224', 'shake_256'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001DFAEAAE400>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001DFAEAAE400>, origin='C:\\\\BuildAgent\\\\system\\\\.persistent_cache\\\\pythons\\\\python38\\\\DLLs\\\\_hashlib.pyd')"
