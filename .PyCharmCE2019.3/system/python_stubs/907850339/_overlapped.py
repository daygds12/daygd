...
def WSAConnect(client_handle, address_as_bytes): # real signature unknown; restored from __doc__
    """
...
class Overlapped(object):
    ...
    def WSASendTo(self, handle, buf, flags, address_as_bytes): # real signature unknown; restored from __doc__
        """
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x00000181E8C734C0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_overlapped', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x00000181E8C734C0>, origin='C:\\\\BuildAgent\\\\system\\\\.persistent_cache\\\\pythons\\\\python38\\\\DLLs\\\\_overlapped.pyd')"
